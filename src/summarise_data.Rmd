...
<td> Psychological ownership</td>
 ...
 <td>
  ...
  Demographics
  1.	What is your gender? [man, woman, non-binary, prefer to not disclose, prefer to self-describe (open response)]
...
if (TRUE) { # if you have data you set this to false
  ...
  data_likert_4<- genLikert(size =  n ,items = 1, levels=4, location=c(-1))
